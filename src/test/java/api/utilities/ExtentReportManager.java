...
public class ExtentReportManager implements ITestListener
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		sparkRepoter=new ExtentSparkReporter(".//reports1//"+repName); //specify the location of the file
		
		sparkRepoter.config().setDocumentTitle("RestAssuredAutomationProject"); //title of the report
		sparkRepoter.config().setReportName("Pet stor user API"); //name of report 
